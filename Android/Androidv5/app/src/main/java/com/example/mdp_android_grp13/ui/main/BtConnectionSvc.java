...
Connect Bluetooth
 */
public class BtConnectionSvc {
    BtPopUp mBluetoothPopup;
    private static BtConnectionSvc instance;
    private static final String TAG = "DebuggingTag";

    private static final String appName = "MDP_Group_13";
    ...
    public BtConnectionSvc(Context context) {
    ...
    private class ConnectThread extends Thread{
        ...
        public void run(){
            ...
            try {
                ...
                try {
                    BtPopUp mBluetoothPopUpActivity = (BtPopUp) mContext;
    ...
    private class ConnectedThread extends Thread{
        ...
        public ConnectedThread(BluetoothSocket socket) {
            ...
            connectionStatus.putExtra("BtStatus", "connected");
        ...
        public void run(){
            ...
            while(true){
                try {
                    ...
                    connectionStatus = new Intent("ConnectionStatus");
                    connectionStatus.putExtra("BtStatus", "disconnected");
                    connectionStatus.putExtra("Device", mDevice);
                    LocalBroadcastManager.getInstance(mContext).sendBroadcast(connectionStatus);
