package com.example.mdp_android_grp13;
...
import com.example.mdp_android_grp13.ui.main.BtConnectionSvc;
import com.example.mdp_android_grp13.ui.main.BtPopUp;
import com.example.mdp_android_grp13.ui.main.CommsFragment;
import com.example.mdp_android_grp13.ui.main.GridMap;
import com.example.mdp_android_grp13.ui.main.MapInformation;
import com.example.mdp_android_grp13.ui.main.MapTabFragment;
import com.example.mdp_android_grp13.ui.main.ReconfigureFragment;
import com.example.mdp_android_grp13.ui.main.SectionsPagerAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popup = new Intent(MainActivity.this, BtPopUp.class);
                startActivity(popup);
            }
        });
        ...
        xAxisTV = findViewById(R.id.xAxisTextView);
        yAxisTV = findViewById(R.id.yAxisTextView);
        directionAxisTV = findViewById(R.id.directionAxisTextView);
        ...
        f1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!f1.getContentDescription().toString().equals("empty"))
                    MainActivity.sendMessage(f1.getContentDescription().toString());
        ...
        f2.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                if (!f2.getContentDescription().toString().equals("empty"))
                    MainActivity.sendMessage(f2.getContentDescription().toString());
    ...
    public static void sendMessage(String message) {
        ...
        if (BtConnectionSvc.BluetoothConnectionStatus == true) {
            byte[] bytes = message.getBytes(Charset.defaultCharset());
            BtConnectionSvc.write(bytes);
        }
        showLog(message);
        editor.putString("message", CommsFragment.getMessageReceivedTextView().getText() + "\n" + message);
        editor.commit();
...
//            case "starting":
            case "waypoint":
                ...
                jsonObject.put("y", y);
                //message = name + " (" + x + "," + y + ")";
                message = "X" + String.valueOf(x) + "," + String.valueOf(y);  // 14/10 ziming doesn't want the name
                showLog(message);
                break;
            default:
    ...
    public static void refreshLabel() {
        xAxisTV.setText(String.valueOf(gridMap.getCurCoord()[0]-1));
        yAxisTV.setText(String.valueOf(gridMap.getCurCoord()[1]-1));
        directionAxisTV.setText(sharedPreferences.getString("direction",""));
    }
...
//                mBluetoothConnection = new BtConnectionSvc(MainActivity.this);
...
// Message Receive to display mdf string
