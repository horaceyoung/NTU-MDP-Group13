...
import com.example.mdp_android_grp13.ui.main.BTConnection;
import com.example.mdp_android_grp13.ui.main.BTDisplay;
import com.example.mdp_android_grp13.ui.main.CommsFragment;
import com.example.mdp_android_grp13.ui.main.GridMap;
import com.example.mdp_android_grp13.ui.main.MapInfo;
...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bluetoothButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent popup = new Intent(MainActivity.this, BTDisplay.class);
                startActivity(popup);
            }
        });
    ...
    public static void printMessage(String message) {
        ...
        if (BTConnection.BluetoothConnectionStatus == true) {
