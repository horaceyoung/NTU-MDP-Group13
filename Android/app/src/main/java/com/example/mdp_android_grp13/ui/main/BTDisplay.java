...
public class BTDisplay extends AppCompatActivity {
    ...
    public BTDeviceListAdapter mNewDevlceListAdapter;
    public BTDeviceListAdapter mPairedDevlceListAdapter;
    ...
    Runnable reconnectionRunnable = new Runnable() {
        ...
        public void run() {
            // Magic here
            try {
                if (BTConnection.BluetoothConnectionStatus == false) {
                    startBTConnection(mBTDevice, myUUID);
                    Toast.makeText(BTDisplay.this, "Reconnection Success", Toast.LENGTH_SHORT).show();

                }
                reconnectionHandler.removeCallbacks(reconnectionRunnable);
                retryConnection = false;
            } catch (Exception e) {
                Toast.makeText(BTDisplay.this, "Failed to reconnect, trying in 5 second", Toast.LENGTH_SHORT).show();
            }
        }
    };
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        otherDevicesListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                if (Build.VERSION.SDK_INT > Build.VERSION_CODES.JELLY_BEAN_MR2) {
                    ...
                    mBTConnection = new BTConnection(BTDisplay.this);
        ...
        bluetoothSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                ...
                if(mBluetoothAdapter ==null){
                    ...
                    Toast.makeText(BTDisplay.this, "Device Does Not Support Bluetooth capabilities!", Toast.LENGTH_LONG).show();
        ...
        connectBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if(mBTDevice ==null)
                {
                    Toast.makeText(BTDisplay.this, "Please Select a Device before connecting.", Toast.LENGTH_LONG).show();
                }
                else {
                    startConnection();
                }
        ...
        myDialog = new ProgressDialog(BTDisplay.this);
    ...
    public void toggleButtonScan(View view){
        ...
        if(mBluetoothAdapter != null) {
            if (!mBluetoothAdapter.isEnabled()) {
                Toast.makeText(BTDisplay.this, "Please turn on Bluetooth first!", Toast.LENGTH_SHORT).show();
            }
            ...
            for(BluetoothDevice d : pairedDevices){
                ...
                mPairedDevlceListAdapter = new BTDeviceListAdapter(this, R.layout.device_adapter_view, mPairedBTDevices);
                pairedDevicesListView.setAdapter(mPairedDevlceListAdapter);
            }
        }
    }
    ...
    private BroadcastReceiver mBroadcastReceiver3 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(BluetoothDevice.ACTION_FOUND)) {
                ...
                mNewDevlceListAdapter = new BTDeviceListAdapter(context, R.layout.device_adapter_view, mNewBTDevices);
                otherDevicesListView.setAdapter(mNewDevlceListAdapter);
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(action.equals(BluetoothDevice.ACTION_BOND_STATE_CHANGED)){
                ...
                if(mDevice.getBondState() == BluetoothDevice.BOND_BONDED){
                    ...
                    Toast.makeText(BTDisplay.this, "Successfully paired with " + mDevice.getName(), Toast.LENGTH_SHORT).show();
                    mBTDevice = mDevice;
                }
    ...
    private BroadcastReceiver mBroadcastReceiver5 = new BroadcastReceiver() {
        ...
        public void onReceive(Context context, Intent intent) {
            ...
            if(status.equals("connected")){
                ...
                Toast.makeText(BTDisplay.this, "Device now connected to "+mDevice.getName(), Toast.LENGTH_LONG).show();
                ...
                Toast.makeText(BTDisplay.this, "Disconnected from "+mDevice.getName(), Toast.LENGTH_LONG).show();
                mBTConnection = new BTConnection(BTDisplay.this);
//                mBluetoothConnection.startAcceptThread();
    ...
    public void startBTConnection(BluetoothDevice device, UUID uuid){
        ...
        mBTConnection.startClientThread(device, uuid);
    }
