...
public class ControlFragment extends Fragment implements SensorEventListener {
    ...
    public View onCreateView(
        ...
        /*
        When sending control command to the respective devices,
        Add A infront of messsage to send to Arduino,
        Add X infront of message to send to Algo.
        Control, Left, Right, Forward and Backwards to Arduino.
        ES and FS to Algo.
         */
        // Button Listener
        ...
        exploreButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (exploreToggleBtn.getText().equals("EXPLORE")) {
                    ...
                    MainActivity.printMessage("XES"); // START EXPLORATION SEND TO RPI
